...
# Crear modelo Random Forest (hiperparámetros)

print("\n==============================")
print("CREANDO MODELO RANDOM FOREST")
print("==============================")
...
print("\n" + "="*40)
print("RESULTADOS - RANDOM FOREST (Datos Académicos)")
print("="*40)
...
joblib.dump(modelo, "modelo_randomforest_academico.pkl")

print("\n✓ Modelo guardado como 'modelo_randomforest_academico.pkl'")
